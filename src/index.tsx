...
type Bindings = {
	KV: KVNamespace;
	// Removed API_KEY and API_SECRET as they are no longer needed
};
		...
		<div>
			...
			<form
				...
				onSubmit={(event) => {
					...
					if (input) {
						event.currentTarget.action = `/${input.value}`;
					}
				}}
			>
				...
				<input
					...
					required
					pattern="[A-Za-z0-9\-]+"
					// Removed oninput; handled onSubmit instead
				/>
...
// API Endpoint to create shortened URL
